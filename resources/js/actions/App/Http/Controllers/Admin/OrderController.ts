...
/**
* @see \App\Http\Controllers\Admin\OrderController::getData
...
/**
* @see \App\Http\Controllers\Admin\OrderController::updatePaymentStatus
 * @see app/Http/Controllers/Admin/OrderController.php:356
 * @route '/admin/orders/{id}/update-payment'
 */
export const updatePaymentStatus = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
 ...
 * @route '/admin/orders/{id}/update-payment'
 */
updatePaymentStatus.url = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions) => {
    if (typeof args === 'string' || typeof args === 'number') {
        args = { id: args }
    }
 ...
 * @route '/admin/orders/{id}/update-payment'
 */
updatePaymentStatus.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: updatePaymentStatus.url(args, options),
    method: 'post',
})
 ...
 * @route '/admin/orders/{id}/update-payment'
 */
    const updatePaymentStatusForm = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/admin/orders/{id}/update-payment'
 */
        updatePaymentStatusForm.post = (args: { id: string | number } | [id: string | number ] | string | number, options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updatePaymentStatus.url(args, options),
            method: 'post',
        })
    
    updatePaymentStatus.form = updatePaymentStatusForm
const OrderController = { index, create, store, show, edit, update, destroy, getData, updateStatus, updatePaymentStatus }
