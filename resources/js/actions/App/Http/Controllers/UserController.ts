 ...
 * @see app/Http/Controllers/UserController.php:142
...
/**
* @see \App\Http\Controllers\UserController::getData
...
const UserController = { index, create, store, show, edit, update, destroy, getData }
