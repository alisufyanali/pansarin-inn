                            ...
                            {variants.length === 0 ? (
                                ...
                                variants.map(variant => (
                                    <tr key={variant.id} className="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                                        ...
                                        <td className="py-3 px-4">{variant.attributes?.size || '-'}</td>
                                        <td className="py-3 px-4">{variant.attributes?.type || '-'}</td>
                                        <td className="py-3 px-4">Rs. {Number(variant.price || 0).toFixed(2)}</td>
                                        <td className="py-3 px-4">{variant.stock ?? 0}</td>
                                        <td className="py-3 px-4 flex gap-2">
                                            {canEdit ? (
                                                ...
                                                <span className="inline-flex items-center justify-center rounded-md bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-600 opacity-60 w-9 h-9" title="Edit (disabled)">
                                                    <Edit2 size={16} />
                                                </span>
                                            )}
