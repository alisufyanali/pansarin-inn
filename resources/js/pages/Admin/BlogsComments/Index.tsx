...
import { PlusCircle, MessageSquare, CheckCircle, Clock, XCircle, Star } from 'lucide-react';
...
export default function Index({ stats, flash }: Props) {
  ...
  const columns = [
    CommonColumns.id(),
    {
      ...
      cell: (row: BlogComment) => (
        <span className="text-gray-700 dark:text-gray-300 font-medium">
          {row.blog_title || <span className="text-gray-400">N/A</span>}
        </span>
      ),
      width: '180px',
    },
    {
      ...
      cell: (row: BlogComment) => (
        <span className="text-gray-600 dark:text-gray-400">
          {row.user_name || <span className="text-gray-400 italic">Guest</span>}
        </span>
      ),
      width: '140px',
    },
    ...
    },
    {
      ...
      sortable: true,
      cell: (row: BlogComment) => (
        <span className={`px-3 py-1.5 text-xs rounded-full font-medium ${getStatusColor(row.status)}`}>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            ...
            <p className="mt-2 text-gray-600 dark:text-gray-400">
              Manage user comments, reviews, and ratings on blog posts
            </p>
          </div>
        ...
        <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm overflow-hidden">
          <DataTableWrapper
            ...
            searchableKeys={['comments', 'review', 'blog_title', 'user_name']}
