...
export default function SystemTab({ settings }: { settings: any }) {
    ...
    const submit = (e: React.FormEvent) => {
        ...
        post(route('admin.general-settings.updateSystem'), {
            preserveScroll: true,
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        className="w-full h-12 rounded-xl border-gray-200 bg-gray-50/50"
                    />
                </div>
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        onChange={e => setData('system_title', e.target.value)}
                        className="w-full h-12 rounded-xl border-gray-200 bg-gray-50/50"
                    />
                </div>
            </div>
