...
export default function RoleForm({ role, permissions, isEdit = false }: RoleFormProps) {
    ...
    const { data, setData, errors, post, processing } = useForm<RoleFormData>({
        name: role?.name || '',
            ...
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="flex items-center justify-end gap-3">
                    <button
                        type="button"
                        onClick={handleReset}
                        className="px-6 py-2 rounded-lg border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800 flex items-center gap-2"
                    >
                        <X className="w-4 h-4" />
                        Reset
                    </button>
                    <button
                        type="submit"
                        disabled={processing}
                        className="px-6 py-2 rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-medium flex items-center gap-2 disabled:opacity-50"
                    >
