...
import { ArrowLeft, User, Mail, Phone, MapPin, ShieldCheck, Share2, Save, Globe } from 'lucide-react';
            ...
            <form onSubmit={submit} className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm p-6">
                        ...
                        <div>
                            <label className="text-sm font-semibold mb-1.5 block">Address 2 <span className="text-gray-400 text-xs">(optional)</span></label>
                            <textarea value={data.address2} onChange={e => setData('address2', e.target.value)} rows={2} className="w-full px-4 py-2.5 border rounded-lg dark:bg-gray-700" placeholder="Landmark, area, additional info..." />
                ...
                {/* Action Buttons */}
                <div className="lg:col-span-2 flex gap-3 mt-6">
                    <Link
